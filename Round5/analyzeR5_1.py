...
price_df_day_0 = load_price_data('prices_round_3_day_0.csv', 0)
price_df_day_1 = load_price_data('prices_round_3_day_1.csv', 1000000)
price_df_day_2 = load_price_data('prices_round_3_day_2.csv', 2000000)
...
trades_df_day_0 = load_trade_data('trades_round_3_day_0_wn.csv', 0)
trades_df_day_1 = load_trade_data('trades_round_3_day_1_wn.csv', 1000000)
trades_df_day_2 = load_trade_data('trades_round_3_day_2_wn.csv', 2000000)
